...
function pageShellCommands(el){
  ...
  const sections=[
    ...
    {key:'cmdline',    label:'Process Command Lines',         cols:['PID','Process','ImageFileName','Args','Arguments','CommandLine','CmdLine'], src:'cmdline'},
