"""CresCent RAM Forensics Toolkit v6.0 - Popular Locations File Browser (Linux)

Scans lsof / enumerate_files JSON and categorizes files in Linux user-interest directories.
