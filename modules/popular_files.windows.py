"""CresCent RAM Forensics Toolkit v6.0 - Popular Locations File Browser (Windows)

Scans filescan JSON and categorizes files in Windows user-interest directories.
